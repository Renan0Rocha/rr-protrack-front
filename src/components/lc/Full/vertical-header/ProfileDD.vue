        ...
        <template v-slot:activator="{ props }">
            <div class=" text-left px-0 cursor-pointer" variant="text" v-bind="props">
                <div class="d-flex align-center">
                    <v-avatar size="50">
                        <img :src="'/images/profile/user6.jpg'" alt="Renan Rocha" width="50" />
                    </v-avatar>
                    <div class="ml-md-4 d-md-block d-none">
                        <h6 class="text-h6 d-flex align-center text-black font-weight-semibold">Renan Rocha</h6>
        ...
        <v-sheet rounded="lg" width="385" elevation="10" class="mt-5">
            <div class="px-8 pt-6">
                ...
                <div class="d-flex align-center mt-5 pb-6">
                    <v-avatar size="90">
                        <img :src="'/images/profile/user6.jpg'" alt="Foto do Usuário" width="90" />

                    </v-avatar>
                    <div class="ml-5">
                        <h6 class="text-h5 mb-n1">Renan Rocha</h6>
                        ...
                        <div class="d-flex align-center mt-1">
                            ...
                            <span class="text-subtitle-1 text-grey100 font-weight-medium ml-2">renanro919@gmail.com.com</span>
                        </div>
                    </div>
                </div>
                <v-divider></v-divider>
