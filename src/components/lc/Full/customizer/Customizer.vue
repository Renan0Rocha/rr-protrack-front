...
<template>
        ...
        <perfect-scrollbar style="height: calc(100vh - 90px)">
            <div class="pa-6">
                <h6 class="text-h6 mb-2">Layout da barra lateral</h6>
                ...
                <h6 class="text-h6 mt-8 mb-5">Cores de Tema</h6>
                ...
                <h6 class="text-h6 mt-11 mb-5">Cores de Tema Escuro</h6>
                <v-item-group mandatory v-model="customizer.actTheme" class="ml-n2 v-row">
                ...
                <h6 class="text-h6 mt-11 mb-2">Opção de contêiner</h6>
